...
def calculate_distinct_n(text):
    ...
    for sentence in text:
        ...
        n_gram_1.update(ngrams(words, 1))
        n_gram_2.update(ngrams(words, 2))


    # Calculate distinct-n (unique n-grams / total n_grams)
    distinct_1 = (len(n_gram_1) / (sum(n_gram_1.values()) + 1e-16)) * 100
    distinct_2 = (len(n_gram_2) / (sum(n_gram_2.values()) + 1e-16)) * 100
